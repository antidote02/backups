...
* `2020/1/11` `某科学的超电磁炮T` ——
  * `2019/7/13` `某科学的一方通行` ——
  * `2018/10/5` `魔法禁书目录 第三季` ——
  * `2013/8/28` `剧场版 魔法禁书目录炭 SP` ——
  * `2013/4/12` `某科学的超电磁炮S` ——
  * `2013/2/23` `魔法禁书目录 剧场版` ——
  * `2010/10/8` `魔法禁书目录 第二季` ——
  * `2009/10/2` `某科学的超电磁炮` ——
  * `2009/1/23` `魔法禁书目录 炭` ——
  * `2008/10/4` `魔法禁书目录` ——
...
* `2019/1/7` `笨拙之极的上野` ——
* `2019/1/4` `笑容的代价` ——
* `2018/12/30` `女神异闻录5 动画版 年末特别篇「前篇 / 后篇」` ——
  * `2018/4/8` `女神异闻录5 动画版` ——
  * `2016/9/3` `女神异闻录5 -THE DAY BREAKERS-` ——
  * `2014/7/10` `女神异闻录4 黄金版` ——
  * `2013/11/23` `女神异闻录3 剧场版 第一章 春生` ——
  * `2013/4/4` `恶魔幸存者2` ——
  * `2012/6/9` `女神异闻录4剧场版` ——
  * `2011/10/6` `女神异闻录4` ——
  * `2008/1/5` `女神异闻录 圣洁之魂` ——
...
* `2017/1/14` `Rewrite 2nd Season` ——
  * `2016/7/3` `Rewrite` ——
* `2017/1/12` `超级弹丸论破2.5 狛枝凪斗与世界的破坏者` ——
  * `2016/7/15` `弹丸论破3 -绝望篇-` ——
  * `2016/7/11` `弹丸论破3 -未来篇-` ——
  * `2013/7/4` `弹丸论破:希望的学园与绝望的高中生` ——
* `2016/7/1` `小桃小栗Love Love物语` ——
* `2016/4/8` `在下坂本，有何贵干？` ——
* `2016/4/3` `学战都市Asterisk 第二季` ——
  * `2015/10/3` `学战都市Asterisk` ——
* `2015/10/7` `樱子小姐的脚下埋着秘密` ——
* `2015/6/24` `Angel Beats! 地狱的厨房` ——
  * `2010/12/22` `Angel Beats! 另一个后记` ——
  * `2010/12/22` `Angel Beats! 通向天堂的阶梯` ——
  * `2010/4/2` `Angel Beats!`
* `2015/4/25` `剧场版 境界的彼方 -I'LL BE HERE- 未来篇` ——
  * `2015/3/14` `剧场版 境界的彼方 -I'LL BE HERE- 过去篇` ——
  * `2013/11/18` `境界的彼方 偶像裁判！~即使迷茫也要裁决之人~` ——
  * `2013/10/2` `境界的彼方` ——
